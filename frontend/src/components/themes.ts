...
export const appThemes: AppTheme[] = [
  ...
  },
  {
    id: 'rose-pine',
    name: 'Rosé Pine',
    description: '以松木深色、晚秋玫瑰色和温柔香槟色为点缀组合的日系护眼主题',
    author: 'rose-pine',
    terminal: {
      background: '#191724', foreground: '#e0def4', cursor: '#524f67',
      selectionBackground: '#2a273f', black: '#26233a', red: '#eb6f92',
      green: '#31748f', yellow: '#f6c177', blue: '#9ccfd8', magenta: '#c4a7e7',
      cyan: '#ebbcba', white: '#e0def4', brightBlack: '#908caa',
      brightRed: '#eb6f92', brightGreen: '#31748f', brightYellow: '#f6c177',
      brightBlue: '#9ccfd8', brightMagenta: '#c4a7e7', brightCyan: '#ebbcba',
      brightWhite: '#e0def4',
    },
    ui: {
      surface0: '#191724',
  ...
  },
  {
    id: 'synthwave-84',
    name: "SynthWave '84",
    description: '极具深空迷幻感的赛博朋克深紫底色，带有霓虹反差色',
    author: 'Robb Owen',
    terminal: {
      background: '#262335', foreground: '#ffffff', cursor: '#f92aad',
      selectionBackground: '#ffffff20', black: '#262335', red: '#fe4450',
      green: '#72f1b8', yellow: '#fede5d', blue: '#03edf9', magenta: '#ff7edb',
      cyan: '#03edf9', white: '#ffffff', brightBlack: '#848bbd',
      brightRed: '#fe4450', brightGreen: '#72f1b8', brightYellow: '#fede5d',
      brightBlue: '#03edf9', brightMagenta: '#ff7edb', brightCyan: '#03edf9',
      brightWhite: '#ffffff',
    },
    ui: {
      surface0: '#262335',
  ...
  },
  {
    id: 'aura-dark',
    name: 'Aura Dark',
    description: '神秘且极具设计感的夜空魔幻紫',
    author: 'Dalton Menezes',
    terminal: {
      background: '#15141b', foreground: '#edecee', cursor: '#a277ff',
      selectionBackground: '#312b3f', black: '#15141b', red: '#ff6767',
      green: '#61ffca', yellow: '#ffca85', blue: '#82e2ff', magenta: '#a277ff',
      cyan: '#61ffca', white: '#edecee', brightBlack: '#4d4d4d',
      brightRed: '#ff6767', brightGreen: '#61ffca', brightYellow: '#ffca85',
      brightBlue: '#82e2ff', brightMagenta: '#a277ff', brightCyan: '#61ffca',
      brightWhite: '#edecee',
    },
    ui: {
      surface0: '#15141b',
  ...
  },
  {
    id: 'geist-midnight',
    name: 'Geist Midnight',
    description: 'Vercel 官网风格极其纯粹的高反差冷黑极简主题',
    author: 'Vercel',
    terminal: {
      background: '#000000', foreground: '#ededed', cursor: '#ffffff',
      selectionBackground: '#333333', black: '#000000', red: '#ff0000',
      green: '#00ff00', yellow: '#ffff00', blue: '#0000ff', magenta: '#ff00ff',
      cyan: '#00ffff', white: '#ededed', brightBlack: '#666666',
      brightRed: '#ff3333', brightGreen: '#33ff33', brightYellow: '#ffff33',
      brightBlue: '#3333ff', brightMagenta: '#ff33ff', brightCyan: '#33ffff',
      brightWhite: '#ffffff',
    },
    ui: {
      surface0: '#000000',
  ...
  },
  {
    id: 'github-light',
    name: 'GitHub Light',
    description: '经典的 GitHub 默认浅色护眼主题，极其适合日常明亮的办公环境',
    author: 'GitHub',
    terminal: {
      background: '#ffffff', foreground: '#24292f', cursor: '#0969da',
      selectionBackground: '#b3d4ff', black: '#24292f', red: '#cf222e',
      green: '#1a7f37', yellow: '#9a6700', blue: '#0969da', magenta: '#8250df',
      cyan: '#1b7c83', white: '#6e7781', brightBlack: '#57606a',
      brightRed: '#a40e26', brightGreen: '#116329', brightYellow: '#805b10',
      brightBlue: '#0550ae', brightMagenta: '#6639ba', brightCyan: '#125c61',
      brightWhite: '#8c959f',
    },
    ui: {
      surface0: '#f6f8fa',
  ...
  },
  {
    id: 'one-light',
    name: 'One Light',
    description: 'Atom 的浅色极简主义版本，色彩生动对比明快的清爽选择',
    author: 'Atom',
    terminal: {
      background: '#fafafa', foreground: '#383a42', cursor: '#526fff',
      selectionBackground: '#e5e5e6', black: '#383a42', red: '#e45649',
      green: '#50a14f', yellow: '#c18401', blue: '#4078f2', magenta: '#a626a4',
      cyan: '#0184bc', white: '#a0a1a7', brightBlack: '#696c77',
      brightRed: '#ca1243', brightGreen: '#238636', brightYellow: '#986801',
      brightBlue: '#0184bc', brightMagenta: '#a626a4', brightCyan: '#0184bc',
      brightWhite: '#a0a1a7',
    },
    ui: {
      surface0: '#ebecf0',
  ...
  },
  {
    id: 'everforest',
    name: 'Everforest',
    description: '一款暖色调松林绿护眼主题，极佳的绿色系护眼表现',
    author: 'sainnhe',
    terminal: {
      background: '#2b3339', foreground: '#d3c6aa', cursor: '#d3c6aa',
      selectionBackground: '#445055', black: '#475258', red: '#e67e80',
      green: '#a7c080', yellow: '#dbbc7f', blue: '#7fbbb3', magenta: '#d699b6',
      cyan: '#83c092', white: '#d3c6aa', brightBlack: '#475258',
      brightRed: '#e67e80', brightGreen: '#a7c080', brightYellow: '#dbbc7f',
      brightBlue: '#7fbbb3', brightMagenta: '#d699b6', brightCyan: '#83c092',
      brightWhite: '#d3c6aa',
    },
    ui: {
      surface0: '#232a2e',
  ...
  },
  {
    id: 'fairy-floss',
    name: 'Fairy Floss',
    description: '梦幻柔美的粉紫色系仙女主题',
    author: 'sailorhg',
    terminal: {
      background: '#5a5475', foreground: '#f8f8f2', cursor: '#f8f8f0',
      selectionBackground: '#8c80a2', black: '#464258', red: '#ff857f',
      green: '#c2ffdf', yellow: '#e6c000', blue: '#caa6ff', magenta: '#ffb8d1',
      cyan: '#ffb8d1', white: '#f8f8f2', brightBlack: '#797593',
      brightRed: '#ff857f', brightGreen: '#c2ffdf', brightYellow: '#e6c000',
      brightBlue: '#caa6ff', brightMagenta: '#ffb8d1', brightCyan: '#ffb8d1',
      brightWhite: '#f8f8f0',
    },
    ui: {
      surface0: '#464258',
